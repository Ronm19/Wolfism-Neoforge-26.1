...
/**
 * Lightweight social play for Sculk pups.
 * Combat/threat memory immediately interrupts it.
 */
public final class SculkPupPlayGoal extends Goal {
    ...
    private SculkWolf playmate;
    private int playTicks;

    public SculkPupPlayGoal(SculkWolf wolf) {
        this.wolf = wolf;
        ...
        this.playmate = this.wolf.level()
                .getEntitiesOfClass(
                        ...
                        candidate -> candidate != this.wolf
                                ...
                                && this.wolf.isSculkPackmate(candidate))
                .stream()
    ...
    public void tick() {
        ...
        this.wolf.getLookControl().setLookAt(this.playmate, 30.0F, 30.0F);

        if (this.playTicks % 8 == 0) {
            this.wolf.getNavigation().moveTo(this.playmate, SPEED);
        }
    }
