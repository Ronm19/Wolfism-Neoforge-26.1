...
/** Converts Infernal pack threat memory into coordinated target selection. */
public final class InfernalPackAssistGoal extends Goal {
    private final InfernalWolf wolf;
    private LivingEntity sharedThreat;

    public InfernalPackAssistGoal(InfernalWolf wolf) {
        this.wolf = wolf;
    ...
    public boolean canUse() {
        ...
        if (threat instanceof Creeper
                || !this.wolf.isValidInfernalCombatTarget(threat)) {
            return false;
        }
