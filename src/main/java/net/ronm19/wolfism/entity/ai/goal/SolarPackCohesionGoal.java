...
/** Keeps idle wild adult Solar Wolves moving as a loose pack. */
public final class SolarPackCohesionGoal extends Goal {
    ...
    private SolarWolf packmate;
    private int repathDelay;

    public SolarPackCohesionGoal(SolarWolf wolf) {
        this.wolf = wolf;
    ...
    public boolean canUse() {
        ...
        Optional<SolarWolf> rememberedPackmate = this.wolf.getBrain()
                .getMemory(ModMemoryModuleTypes.NEAREST_SOLAR_PACKMATE.get());
        if (rememberedPackmate.isEmpty()) {
            return false;
        }

        SolarWolf candidate = rememberedPackmate.get();
