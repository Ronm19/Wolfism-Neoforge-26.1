...
/** Keeps idle wild adult Earth Wolves moving as a loose pack. */
public final class EarthPackCohesionGoal extends Goal {
    ...
    private EarthWolf packmate;
    private int repathDelay;

    public EarthPackCohesionGoal(EarthWolf wolf) {
        this.wolf = wolf;
    ...
    public boolean canUse() {
        ...
        Optional<EarthWolf> rememberedPackmate = this.wolf.getBrain()
                .getMemory(ModMemoryModuleTypes.NEAREST_EARTH_PACKMATE.get());
        if (rememberedPackmate.isEmpty()) {
            return false;
        }

        EarthWolf candidate = rememberedPackmate.get();
