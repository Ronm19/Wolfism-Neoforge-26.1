...
/**
 * Lightweight social play for End pups.
 * Combat/threat memory immediately interrupts it.
 */
public final class EndPupPlayGoal extends Goal {
    ...
    private EndWolf playmate;
    private int playTicks;

    public EndPupPlayGoal(EndWolf wolf) {
        this.wolf = wolf;
        ...
        this.playmate = this.wolf.level()
                .getEntitiesOfClass(
                        ...
                        candidate -> candidate != this.wolf
                                ...
                                && this.wolf.isEndPackmate(candidate))
                .stream()
