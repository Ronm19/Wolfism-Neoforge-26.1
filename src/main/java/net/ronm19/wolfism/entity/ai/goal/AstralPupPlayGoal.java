...
/**
 * Lightweight Astral pup play while the pack is safe.
 */
public final class AstralPupPlayGoal
        extends Goal {
    ...
    private AstralWolf playmate;
    private int playTicks;

    public AstralPupPlayGoal(
            AstralWolf wolf) {
