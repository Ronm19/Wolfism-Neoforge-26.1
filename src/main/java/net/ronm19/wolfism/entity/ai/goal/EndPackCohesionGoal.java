...
/**
 * Keeps wild adult End Wolves from slowly dissolving into unrelated solo mobs.
 *
 * <p>Tamed wolves use normal owner-follow behavior instead.</p>
 */
public final class EndPackCohesionGoal extends Goal {
    ...
    private EndWolf packmate;

    public EndPackCohesionGoal(EndWolf wolf) {
        this.wolf = wolf;
    ...
    public boolean canUse() {
        ...
        this.packmate = this.wolf.getBrain()
                .getMemory(ModMemoryModuleTypes.NEAREST_END_PACKMATE.get())
                .orElse(null);
