...
/** Keeps idle wild adult Timber Wolves moving as a loose pack. */
public final class TimberPackCohesionGoal extends Goal {
    ...
    private TimberWolf packmate;
    private int repathDelay;

    public TimberPackCohesionGoal(TimberWolf wolf) {
        this.wolf = wolf;
    ...
    public boolean canUse() {
        ...
        Optional<TimberWolf> rememberedPackmate = this.wolf.getBrain()
                .getMemory(ModMemoryModuleTypes.NEAREST_TIMBER_PACKMATE.get());
        if (rememberedPackmate.isEmpty()) {
            return false;
        }

        TimberWolf candidate = rememberedPackmate.get();
