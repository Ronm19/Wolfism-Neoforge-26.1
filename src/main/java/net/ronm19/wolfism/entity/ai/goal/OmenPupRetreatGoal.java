...
/** Omen pups retreat from remembered pack danger instead of fighting. */
public final class OmenPupRetreatGoal extends Goal {
    ...
    public OmenPupRetreatGoal(OmenWolf wolf) {
        this.wolf = wolf;
    ...
    public boolean canUse() {
        ...
        if (this.threat == null) {
            this.threat = this.wolf.getDevelopingThreat();
        }
    ...
    private void chooseEscapePath() {
        ...
        OmenWolf adult = this.wolf.getBrain()
                .getMemory(
