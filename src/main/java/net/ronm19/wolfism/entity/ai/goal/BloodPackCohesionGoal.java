...
/**
 * Keeps wild adult Blood Wolves from slowly dissolving into unrelated solo mobs.
 *
 * <p>Tamed wolves use normal owner-follow behavior instead.</p>
 */
public final class BloodPackCohesionGoal extends Goal {
    ...
    private BloodWolf packmate;

    public BloodPackCohesionGoal(BloodWolf wolf) {
        this.wolf = wolf;
    ...
    public boolean canUse() {
        ...
        this.packmate = this.wolf.getBrain()
                .getMemory(ModMemoryModuleTypes.NEAREST_BLOOD_PACKMATE.get())
                .orElse(null);
