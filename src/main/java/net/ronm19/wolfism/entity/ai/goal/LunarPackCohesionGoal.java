...
/** Keeps idle wild adult Lunar Wolves moving as a loose pack. */
public final class LunarPackCohesionGoal extends Goal {
    ...
    private LunarWolf packmate;
    private int repathDelay;

    public LunarPackCohesionGoal(LunarWolf wolf) {
        this.wolf = wolf;
    ...
    public boolean canUse() {
        ...
        Optional<LunarWolf> rememberedPackmate = this.wolf.getBrain()
                .getMemory(ModMemoryModuleTypes.NEAREST_LUNAR_PACKMATE.get());
        if (rememberedPackmate.isEmpty()) {
            return false;
        }

        LunarWolf candidate = rememberedPackmate.get();
