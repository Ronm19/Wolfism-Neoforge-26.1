...
/**
 * Lightweight social play for Blood pups.
 * Combat/threat memory immediately interrupts it.
 */
public final class BloodPupPlayGoal extends Goal {
    ...
    private BloodWolf playmate;
    private int playTicks;

    public BloodPupPlayGoal(BloodWolf wolf) {
        this.wolf = wolf;
        ...
        this.playmate = this.wolf.level()
                .getEntitiesOfClass(
                        ...
                        candidate -> candidate != this.wolf
                                ...
                                && this.wolf.isBloodPackmate(candidate))
                .stream()
