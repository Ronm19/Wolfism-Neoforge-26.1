...
/** Lightweight social play for Omen pups when the pack is safe. */
public final class OmenPupPlayGoal extends Goal {
    ...
    private OmenWolf playmate;
    private int playTicks;

    public OmenPupPlayGoal(OmenWolf wolf) {
        this.wolf = wolf;
        ...
        this.playmate = this.wolf.level()
                .getEntitiesOfClass(
                        ...
                        candidate -> candidate != this.wolf
                                ...
                                && this.wolf.isOmenPackmate(candidate))
                .stream()
                .min(
