...
/** Keeps idle wild adult Frost Wolves moving as a loose pack. */
public final class FrostPackCohesionGoal extends Goal {
    ...
    private FrostWolf packmate;
    private int repathDelay;

    public FrostPackCohesionGoal(FrostWolf wolf) {
        this.wolf = wolf;
    ...
    public boolean canUse() {
        ...
        Optional<FrostWolf> rememberedPackmate = this.wolf.getBrain()
                .getMemory(ModMemoryModuleTypes.NEAREST_FROST_PACKMATE.get());
        if (rememberedPackmate.isEmpty()) {
            return false;
        }

        FrostWolf candidate = rememberedPackmate.get();
