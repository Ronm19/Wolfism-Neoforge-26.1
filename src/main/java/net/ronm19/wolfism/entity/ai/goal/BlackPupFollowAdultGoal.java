...
/** Wild Black Wolf pups stay near a remembered adult pack member. */
public final class BlackPupFollowAdultGoal extends Goal {
    ...
    private BlackWolf adult;
    private int repathDelay;

    public BlackPupFollowAdultGoal(BlackWolf pup) {
        this.pup = pup;
