...
/** Keeps idle wild Infernal Wolves together as a loose war-pack. */
public final class InfernalPackCohesionGoal extends Goal {
    ...
    private InfernalWolf packmate;

    public InfernalPackCohesionGoal(InfernalWolf wolf) {
        this.wolf = wolf;
    ...
    public boolean canUse() {
        ...
        this.packmate = this.wolf.getBrain()
                .getMemory(ModMemoryModuleTypes.NEAREST_INFERNAL_PACKMATE.get())
                .orElse(null);
