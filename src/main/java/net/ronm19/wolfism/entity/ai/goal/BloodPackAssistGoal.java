...
/**
 * Converts Blood pack threat memory into a real combat target.
 *
 ...
 */
public final class BloodPackAssistGoal extends Goal {
    private final BloodWolf wolf;
    private LivingEntity sharedThreat;

    public BloodPackAssistGoal(BloodWolf wolf) {
        this.wolf = wolf;
    ...
    public boolean canUse() {
        ...
        if (threat instanceof Creeper || !this.wolf.isValidBloodCombatTarget(threat)) {
            return false;
        }
