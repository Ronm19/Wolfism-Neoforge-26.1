...
public final class ArcticPupFollowAdultGoal extends Goal {
    ...
    private ArcticWolf adult;
    private int repathDelay;

    public ArcticPupFollowAdultGoal(ArcticWolf pup) {
        this.pup = pup;
