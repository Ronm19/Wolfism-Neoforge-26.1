...
public final class WaterPupRetreatGoal extends Goal {
    ...
    public WaterPupRetreatGoal(WaterWolf pup) {
        this.pup = pup;
    ...
    public void tick() {
        ...
        if (this.safeAnchor != null && this.safeAnchor.isAlive()) {
            this.pup.moveToWaterAware(this.safeAnchor, SPEED);
            return;
        }
        ...
        this.pup.moveToWaterAware(fleeX, this.pup.getY(), fleeZ, SPEED);
    }
