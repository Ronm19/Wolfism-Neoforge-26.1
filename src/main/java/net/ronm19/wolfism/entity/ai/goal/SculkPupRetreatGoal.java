...
/**
 * Sculk pups never fight. When their pack remembers a threat, they retreat
 * toward safety or physically away from the attacker.
 */
public final class SculkPupRetreatGoal extends Goal {
    ...
    public SculkPupRetreatGoal(SculkWolf wolf) {
        this.wolf = wolf;
    ...
    private void chooseEscapePath() {
        ...
        SculkWolf adult = this.wolf.getBrain()
