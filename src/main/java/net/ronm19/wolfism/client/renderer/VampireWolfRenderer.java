...
/** Vanilla wolf geometry; the user's charcoal/crimson texture does the work. */
public final class VampireWolfRenderer
        extends AgeableMobRenderer<VampireWolf, WolfRenderState, WolfModel> {

    private static final Identifier ADULT_TEXTURE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID,
            "textures/entity/wolf/vampire_wolf.png");

    private static final Identifier BABY_TEXTURE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID,
            "textures/entity/wolf/vampire_wolf_baby.png");
    ...
    public void extractRenderState(
        ...
        state.isAngry = entity.isAngry() || entity.isVampireCombatVisualActive();
