...
/** Dedicated collar-only render pass for Phantom Wolf. */
public final class PhantomWolfCollarLayer extends RenderLayer<WolfRenderState, WolfModel> {
