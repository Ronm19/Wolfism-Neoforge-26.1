...
/**
 * Vanilla wolf geometry on purpose. Spectral's identity comes from the strict
 * vanilla-pattern charcoal/cyan texture plus gameplay particles, not a custom
 * model.
 */
public final class SpectralWolfRenderer
        extends AgeableMobRenderer<SpectralWolf, WolfRenderState, WolfModel> {

    private static final Identifier ADULT_TEXTURE =
            Identifier.fromNamespaceAndPath(
                    Wolfism.MOD_ID,
                    "textures/entity/wolf/spectral_wolf.png");

    private static final Identifier BABY_TEXTURE =
            Identifier.fromNamespaceAndPath(
                    Wolfism.MOD_ID,
                    "textures/entity/wolf/spectral_wolf_baby.png");
    ...
    public void extractRenderState(
        ...
        state.isAngry = entity.isAngry()
                || entity.isSpectralCombatVisualActive();
