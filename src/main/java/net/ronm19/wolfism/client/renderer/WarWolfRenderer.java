...
/**
 * Vanilla wolf geometry. War Wolf stays intentionally strict: the visual
 * identity comes from the approved adult/baby recolors, never custom geometry.
 */
public final class WarWolfRenderer
        extends AgeableMobRenderer<WarWolf, WolfRenderState, WolfModel> {

    private static final Identifier ADULT_TEXTURE =
            Identifier.fromNamespaceAndPath(
                    Wolfism.MOD_ID,
                    "textures/entity/wolf/war_wolf.png");

    private static final Identifier BABY_TEXTURE =
            Identifier.fromNamespaceAndPath(
                    Wolfism.MOD_ID,
                    "textures/entity/wolf/war_wolf_baby.png");

    public WarWolfRenderer(EntityRendererProvider.Context context) {
        super(
                context,
    ...
    public void extractRenderState(
        ...
        state.isAngry = entity.isAngry()
                || entity.isWarCombatVisualActive();
