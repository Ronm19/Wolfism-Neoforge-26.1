...
/**
 * Vanilla-geometry renderer for Skeleton Wolf. The skeletal silhouette comes
 * entirely from transparent pixels in the supplied adult/baby textures.
 */
public final class SkeletonWolfRenderer extends WolfRenderer {
    private static final Identifier ADULT_TEXTURE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/skeleton_wolf.png");
    private static final Identifier BABY_TEXTURE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/skeleton_wolf_baby.png");
