...
/** Vanilla wolf geometry with rose-heart seasonal texture states. */
public final class ValentinesWolfRenderer
        extends AgeableMobRenderer<ValentinesWolf, WolfRenderState, WolfModel> {
    private static final Identifier ADULT_NORMAL = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/valentines_wolf.png");
    private static final Identifier ADULT_ACTIVE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/valentines_wolf_active.png");
    private static final Identifier BABY_NORMAL = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/valentines_wolf_baby.png");
    private static final Identifier BABY_ACTIVE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/valentines_wolf_baby_active.png");

    public ValentinesWolfRenderer(EntityRendererProvider.Context context) {
        super(context,
    ...
    @Override
    public void extractRenderState(ValentinesWolf entity, WolfRenderState state, float partialTick) {
        super.extractRenderState(entity, state, partialTick);
        state.isAngry = entity.isAngry() || entity.isHeartVisualActive();
