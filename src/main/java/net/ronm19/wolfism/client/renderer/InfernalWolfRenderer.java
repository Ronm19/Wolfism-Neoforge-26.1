...
/** Vanilla-wolf geometry renderer for Infernal Wolf. */
public final class InfernalWolfRenderer extends AgeableMobRenderer<InfernalWolf, WolfRenderState, WolfModel> {

    private static final Identifier ADULT_TEXTURE =
            Identifier.fromNamespaceAndPath(
                    Wolfism.MOD_ID,
                    "textures/entity/wolf/infernal_wolf.png");

    private static final Identifier BABY_TEXTURE =
            Identifier.fromNamespaceAndPath(
                    Wolfism.MOD_ID,
                    "textures/entity/wolf/infernal_wolf_baby.png");

    public InfernalWolfRenderer(EntityRendererProvider.Context context) {
        super(
                context,
    ...
    public void extractRenderState(
        ...
        state.isAngry = entity.isAngry()
                || entity.isInfernalRageActive()
                || entity.isInfernalStriking();

        // Physical sitting pose only: avoids the stale ordered-sit renderer bug.
