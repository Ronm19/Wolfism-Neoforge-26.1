...
/** Vanilla wolf geometry; Wither Wolf's mutation identity lives in texture and FX. */
public final class WitherWolfRenderer
        extends AgeableMobRenderer<WitherWolf, WolfRenderState, WolfModel> {

    private static final Identifier ADULT_TEXTURE =
            Identifier.fromNamespaceAndPath(
                    Wolfism.MOD_ID,
                    "textures/entity/wolf/wither_wolf.png");

    private static final Identifier BABY_TEXTURE =
            Identifier.fromNamespaceAndPath(
                    Wolfism.MOD_ID,
                    "textures/entity/wolf/wither_wolf_baby.png");

    public WitherWolfRenderer(EntityRendererProvider.Context context) {
        super(
                context,
    ...
    public void extractRenderState(
        ...
        state.isAngry = entity.isAngry() || entity.isWitherCombatVisualActive();
