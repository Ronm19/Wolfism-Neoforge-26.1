...
/**
 * Violet uses the vanilla adult/baby wolf models exactly; only the texture is
 * species-specific. No redundant custom model classes are required.
 */
public final class VioletWolfRenderer extends WolfRenderer {
    private static final Identifier ADULT_TEXTURE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/violet_wolf.png");
    private static final Identifier BABY_TEXTURE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/violet_wolf_baby.png");
