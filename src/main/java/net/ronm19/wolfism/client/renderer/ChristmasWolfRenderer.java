...
/** Vanilla wolf geometry with winter-fur and festive-support texture states. */
public final class ChristmasWolfRenderer
        extends AgeableMobRenderer<ChristmasWolf, WolfRenderState, WolfModel> {

    private static final Identifier ADULT_NORMAL = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/christmas_wolf.png");
    private static final Identifier ADULT_ACTIVE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/christmas_wolf_active.png");
    private static final Identifier BABY_NORMAL = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/christmas_wolf_baby.png");
    private static final Identifier BABY_ACTIVE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/christmas_wolf_baby_active.png");

    public ChristmasWolfRenderer(EntityRendererProvider.Context context) {
        super(
                context,
    ...
    public void extractRenderState(
            ChristmasWolf entity,
            WolfRenderState state,
            float partialTick) {
        super.extractRenderState(entity, state, partialTick);
        // Reuse vanilla's synced angry presentation flag as our renderer-level
        // festive-support switch. This keeps vanilla collar/armor layers compatible.
        state.isAngry = entity.isAngry() || entity.isFestiveActive();
