...
/** Sand-specific renderer while preserving vanilla wolf models/layers. */
public final class SandWolfRenderer extends WolfRenderer {
    private static final Identifier ADULT_TEXTURE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/sand_wolf.png");
    private static final Identifier BABY_TEXTURE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/sand_wolf_baby.png");

    public SandWolfRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
