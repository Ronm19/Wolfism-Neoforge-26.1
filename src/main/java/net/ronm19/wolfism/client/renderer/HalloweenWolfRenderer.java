...
/** Vanilla wolf geometry with normal and jack-o'-lantern-eye texture states. */
public final class HalloweenWolfRenderer
        extends AgeableMobRenderer<HalloweenWolf, WolfRenderState, WolfModel> {

    private static final Identifier ADULT_NORMAL = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/halloween_wolf.png");
    private static final Identifier ADULT_ACTIVE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/halloween_wolf_active.png");
    private static final Identifier BABY_NORMAL = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/halloween_wolf_baby.png");
    private static final Identifier BABY_ACTIVE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/halloween_wolf_baby_active.png");

    public HalloweenWolfRenderer(EntityRendererProvider.Context context) {
        super(
                context,
    ...
    public void extractRenderState(
            HalloweenWolf entity,
            WolfRenderState state,
            float partialTick) {
        super.extractRenderState(entity, state, partialTick);
        // Reuse vanilla's synced angry presentation flag as our renderer-level
        // active/dormant switch. This keeps vanilla collar/armor layers compatible.
        state.isAngry = entity.isAngry() || entity.isHalloweenIlluminated();
