 ...
 * Grave Wolf renderer.
 *
 * <p>Grave intentionally uses vanilla adult/baby wolf geometry. His identity
 * comes from the charcoal/bone/purple texture work and gameplay particles,
 * so no custom model layer is required.</p>
 */
public final class GraveWolfRenderer
        extends AgeableMobRenderer<GraveWolf, WolfRenderState, WolfModel> {

    private static final Identifier ADULT_TEXTURE =
            Identifier.fromNamespaceAndPath(
                    Wolfism.MOD_ID,
                    "textures/entity/wolf/grave_wolf.png");

    private static final Identifier BABY_TEXTURE =
            Identifier.fromNamespaceAndPath(
                    Wolfism.MOD_ID,
                    "textures/entity/wolf/grave_wolf_baby.png");

    public GraveWolfRenderer(EntityRendererProvider.Context context) {
        super(
                context,
                new AdultWolfModel(
        ...
        /*
         * Grave uses vanilla wolf UV geometry, so the vanilla dyeable collar
         * layer is correct here.
         */
    ...
    public void extractRenderState(
        ...
        /*
         * Use only the synchronized physical sitting pose.
         * isOrderedToSit() is command/AI state and can visually lag behind the
         * server, which is exactly the problem we already fixed on Demon/Blood.
         */
