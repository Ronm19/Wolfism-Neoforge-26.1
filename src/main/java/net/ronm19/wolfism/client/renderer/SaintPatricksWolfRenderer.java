...
/** Vanilla wolf geometry with emerald/cream luck-state textures. */
public final class SaintPatricksWolfRenderer
        extends AgeableMobRenderer<SaintPatricksWolf, WolfRenderState, WolfModel> {

    private static final Identifier ADULT_NORMAL = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID,
            "textures/entity/wolf/saint_patricks_wolf.png");
    private static final Identifier ADULT_ACTIVE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID,
            "textures/entity/wolf/saint_patricks_wolf_active.png");
    private static final Identifier BABY_NORMAL = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID,
            "textures/entity/wolf/saint_patricks_wolf_baby.png");
    private static final Identifier BABY_ACTIVE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID,
            "textures/entity/wolf/saint_patricks_wolf_baby_active.png");

    public SaintPatricksWolfRenderer(EntityRendererProvider.Context context) {
        super(
                context,
    ...
    public Identifier getTextureLocation(WolfRenderState state) {
        if (state.isBaby) return state.isAngry ? BABY_ACTIVE : BABY_NORMAL;
    ...
    public void extractRenderState(
            SaintPatricksWolf entity,
            WolfRenderState state,
            float partialTick) {
        super.extractRenderState(entity, state, partialTick);
        state.isAngry = entity.isAngry() || entity.isFortuneVisualActive();
