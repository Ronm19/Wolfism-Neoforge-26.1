...
/** Vanilla wolf geometry with midnight rocket/firework texture states. */
public final class FireworkWolfRenderer
        extends AgeableMobRenderer<FireworkWolf, WolfRenderState, WolfModel> {
    private static final Identifier ADULT_NORMAL = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/firework_wolf.png");
    private static final Identifier ADULT_ACTIVE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/firework_wolf_active.png");
    private static final Identifier BABY_NORMAL = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/firework_wolf_baby.png");
    private static final Identifier BABY_ACTIVE = Identifier.fromNamespaceAndPath(
            Wolfism.MOD_ID, "textures/entity/wolf/firework_wolf_baby_active.png");

    public FireworkWolfRenderer(EntityRendererProvider.Context context) {
        super(context,
    ...
    @Override
    public void extractRenderState(FireworkWolf entity, WolfRenderState state, float partialTick) {
        super.extractRenderState(entity, state, partialTick);
        state.isAngry = entity.isAngry() || entity.isFireworkVisualActive();
